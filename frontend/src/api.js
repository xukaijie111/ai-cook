...
export const api = {
  ...
  updateDish: (dishId, body) => request(`/dishes/${dishId}`, { method: 'PATCH', body: JSON.stringify(body) }),
  updatePrompt: (promptId, body) => request(`/prompts/${promptId}`, { method: 'PATCH', body: JSON.stringify(body) }),
